...
class AssetTest(YerbasTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("YERBAS1", 1000)
        n0.issue("YERBAS2", 1000)
        n0.issue("YERBAS3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="YERBAS*", verbose=False, count=2, start=-2)
        ...
        yerbas_assets = n0.listassets(asset="YERBAS*", verbose=False, count=2, start=-2)
        assert_equal(len(yerbas_assets), 2)
        assert_equal(yerbas_assets[0], "YERBAS2")
        assert_equal(yerbas_assets[1], "YERBAS3")
        self.sync_all()
