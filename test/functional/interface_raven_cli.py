...
class TestYerbasCli(YerbasTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `yerbas-cli getinfo`")
        ...
        self.log.info("Compare responses from `yerbas-cli -getinfo` and the RPCs data is retrieved from.")
