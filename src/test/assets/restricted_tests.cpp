...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler yerb tx
        CScript yerbTransfer = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        CTxOut yerbOut(1*COIN, yerbTransfer);
        ...
        mutTxTest1.vout.emplace_back(yerbOut);
        ...
        mutTxTest2.vout.emplace_back(yerbOut);
        ...
        mutTxTest3.vout.emplace_back(yerbOut);
        ...
        mutTxTest4.vout.emplace_back(yerbOut);
        ...
        mutTxTest5.vout.emplace_back(yerbOut);
        ...
        mutTxTest6.vout.emplace_back(yerbOut);
        ...
        mutTxTest7.vout.emplace_back(yerbOut);
        ...
        mutTxTest8.vout.emplace_back(yerbOut);
