    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
 ...
 ///   ui->frame_2->setGraphicsEffect(GUIUtil::getShadowEffect());
    ...
    ui->yerbBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->yerbBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the YERB balance grid from expanding and looking terrible when asset balance is hidden
