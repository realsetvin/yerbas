...
/* Yerbas shadow color - light mode */
...
/* Yerbas label color as a string */
...
#define QAPP_APP_NAME_DEVNET "Yerbas-Qt-DevNet"
#define QAPP_APP_NAME_REGTEST "Yerbas-Qt-regtest"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://explorer.org/tx/%s|https://www.assetsexplorer.com/tx/%s|https://explorer2.yerbas.org/tx/%s"
